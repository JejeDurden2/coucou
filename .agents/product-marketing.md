...
**Catégorie :** Cabinet de conseil et d'intégration IA (conseil + delivery technique). Sur l'étagère mentale du client : « accompagnement IA » / « intégrateur IA » / « agence IA », mais positionné au-dessus des agences et en dessous du prix des grands cabinets.

**Type d'activité :** Société de services (prestations projet), pas un SaaS. Facturation au projet / à la mission.

**Modèle économique & tarifs :** Sur devis, après conversation commerciale. **Les prix ne sont jamais publiés.** Le tarif dépend du périmètre, découvert lors du diagnostic. Point de conversion principal : **réserver un diagnostic gratuit**.

### Les deux services

1. **Audit & stratégie IA** : diagnostic de l'existant, cartographie des opportunités, business cases chiffrés (ROI), feuilles de route IA priorisées. Livrable : un plan d'action classé par impact et faisabilité, pas un rapport qui dort dans un tiroir.
2. **Développement IA sur mesure** : agents IA, systèmes RAG, automatisations, intégrations dans les outils déjà utilisés par le client. Livrable : un système qui tourne en production, mesuré sur ses résultats.

---

## Audience cible

**Entreprises visées :** PME françaises (10-250 salariés) et ETI (250-5000 salariés). **Explicitement pas** les grands comptes (CAC 40, cycles de vente interminables, appels d'offres), **ni** les startups (pas de budget, cherchent un CTO pas un cabinet). Cœur de cible : entreprises établies, rentables, avec des processus réels à optimiser et un dirigeant qui décide vite.

**Secteurs porteurs [À VALIDER] :** industrie & distribution, services BtoB, santé/médico-social, assurance/mutuelle, cabinets professionnels (compta, juridique), e-commerce. À affiner selon les premiers clients signés.

**Décideurs :** dirigeant / DG (PME), directeur de BU, DSI ou responsable transformation / digital (ETI), directeur des opérations, secrétaire général. En PME, c'est souvent le dirigeant lui-même qui décide et signe.

**Problème principal résolu :** « On sait que l'IA va compter, on ne sait pas par où commencer ni si ça marchera vraiment chez nous. » Nous transformons une intuition floue en systèmes déployés à ROI prouvé.

**Ce pour quoi on nous « embauche » (jobs to be done) :**
- Savoir où l'IA rapporte vraiment dans MON entreprise (et où elle ne sert à rien) : arrêter de deviner.
- Passer du POC qui ne sort jamais du labo à un système qui tourne en production.
- Automatiser des tâches chronophages sans embaucher, sans monter une équipe data en interne.
- Ne pas se faire distancer par les concurrents qui, eux, s'y mettent.

**Cas d'usage typiques [À VALIDER, illustratifs] :**
- Agent de réponse aux appels d'offres / devis à partir de la base documentaire interne.
- Assistant support client (RAG sur la doc produit + historique tickets).
- Automatisation du traitement de documents (factures, contrats, comptes rendus).
- Recherche interne intelligente sur des données éparpillées (Drive, mails, ERP, SharePoint).
- Qualification et routage automatique des leads / demandes entrantes.
...
**Problème central :** Les dirigeants de PME/ETI savent que l'IA est incontournable mais sont paralysés : trop de bruit, pas de repère fiable, la peur d'investir dans quelque chose qui ne produira jamais de résultat concret. Résultat : ils attendent, pendant que la pression concurrentielle monte.
...
**Ce que ça leur coûte :** des heures perdues sur des tâches automatisables, des talents qui font du travail à faible valeur, des concurrents qui prennent de l'avance, des données mal exploitées, et des budgets déjà engloutis dans des POC morts sans aucun retour.

**Tension émotionnelle :** peur de rater le train / d'être ringardisé ; peur de se faire arnaquer (« encore un consultant qui vend du buzzword ») ; sentiment d'être submergé par le sujet ; scepticisme après une première tentative ratée ; solitude du dirigeant face à une décision technique qu'il ne maîtrise pas.
...
## Dynamique de décision (les 4 forces)
...
**Anxiety (ce qui les inquiète face au changement) :** peur de payer pour rien, de la complexité technique, de la sécurité des données, de l'adoption par les équipes, de dépendre d'un prestataire, de refaire l'expérience du POC abandonné.

---

## Langage client

**Comment ils décrivent le problème (verbatim [À VALIDER], à collecter en entretien) :**
- « On sait qu'il faut s'y mettre mais on ne sait pas par où commencer. »
- « J'ai peur de me faire vendre du vent. »
- « On a testé ChatGPT mais concrètement ça n'a rien changé. »
- « On n'a personne en interne pour gérer ça. »
- « Nos données sont partout, dans tous les sens. »

**Comment ils devraient décrire notre solution (verbatim cible [À VALIDER]) :**
- « Ils m'ont dit franchement où l'IA servait chez moi, et où elle ne servait à rien. »
...
**Ton :** confiant, direct, avec un clin d'œil. Le nom « Coucou » est assumé comme un atout mémorable et sympathique, mais l'expertise est on ne peut plus sérieuse. La complicité dans le ton, le sérieux dans le fond.

**Style :** phrases courtes, affirmations nettes, orienté résultat. On parle au dirigeant, pas à l'ingénieur : concret avant technique. Forme de politesse « **vous** ». On évite le jargon et les promesses creuses. Un humour léger et maîtrisé est bienvenu ; jamais au détriment de la crédibilité.

**Personnalité (3-5 adjectifs) :** confiante, directe, maligne (« smart »), fiable, accessible.
...
> ⚠️ Positionnement en cours de lancement (rebrand). **Aucune metric ni référence client ne doit être publiée tant qu'elle n'est pas validée par le fondateur.** Tous les éléments ci-dessous sont des emplacements **[À VALIDER]**. Ne pas fabriquer de crédentiels.

**Metrics à citer (une fois prouvées) [À VALIDER] :** % de temps gagné sur un process, € de coûts réduits, délai de mise en production, nombre de systèmes déployés.

**Clients / logos [À VALIDER] :** à constituer au fil des missions signées. Demander l'autorisation d'affichage.

**Témoignages [À VALIDER] :**
> « [citation client à recueillir] », [Prénom, fonction, entreprise]
...
**Metrics actuelles :** [À VALIDER, phase de lancement, à instrumenter : visites → prise de RDV → diagnostics réalisés → missions signées].
