...
export type FinalCta = {
  ...
  // Sortie douce de la page d’accueil : un seul lien vers le hub des cartes.
  softExitHubIntro: string;
  softExitHubLabel: string;
...
export const finalCta: FinalCta = {
  ...
  softExitHubIntro: "Pas prêt pour un appel ?",
  softExitHubLabel: "Ouvrez la carte des possibles de votre secteur",
